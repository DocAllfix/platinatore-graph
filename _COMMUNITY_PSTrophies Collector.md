...
```dataview
TABLE source_file, type FROM #community/PSTrophies_Collector
SORT file.name ASC
```
...
## Top bridge nodes
- [[PSTrophiesOrgCollector]] - degree 6, connects to 2 communities
- [[PSTrophiesOrgCollector — collector per playstationtrophies.org.  PlaystationTrop]] - degree 2, connects to 1 community
- [[Slug per playstationtrophies.org lowercase + trattini, no caratteri speciali.]] - degree 2, connects to 1 community
- [[Collector per guide trofei su playstationtrophies.org.]] - degree 2, connects to 1 community
- [[Costruisce l'URL della guida per un gioco.]] - degree 2, connects to 1 community