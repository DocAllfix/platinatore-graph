...
```dataview
TABLE source_file, type FROM #community/DB_Pool_+_Express_Entry
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_Project Rules + Migration Policy]]
- 2 edges to [[_COMMUNITY_Backend Env Config]]
