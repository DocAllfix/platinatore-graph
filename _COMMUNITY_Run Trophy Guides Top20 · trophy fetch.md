...
# Run Trophy Guides Top20 · trophy fetch
...
- [[main()_5]] - code - harvester\scripts\run_trophy_guides_top20.py
- [[run_trophy_guides_top20.py]] - code - harvester\scripts\run_trophy_guides_top20.py

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Run_Trophy_Guides_Top20_·_trophy_fetch
SORT file.name ASC
```

## Connections to other communities
- 9 edges to [[_COMMUNITY_Orchestrator · per guide]]

## Top bridge nodes
- [[run_trophy_guides_top20.py]] - degree 12, connects to 1 community
- [[_process_trophy()]] - degree 7, connects to 1 community
- [[_discover_guide_sources()]] - degree 4, connects to 1 community
- [[_fetch_and_extract()]] - degree 4, connects to 1 community
- [[_process_game()]] - degree 4, connects to 1 community