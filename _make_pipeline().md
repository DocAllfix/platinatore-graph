...
## Connections
- [[Crea una pipeline con tutti i componenti mockati.]] - `rationale_for` [EXTRACTED]
- [[test_calls_upsert_on_success()]] - `calls` [EXTRACTED]
- [[test_closes_collector()]] - `calls` [EXTRACTED]
