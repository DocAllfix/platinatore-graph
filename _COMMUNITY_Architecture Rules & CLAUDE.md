...
```dataview
TABLE source_file, type FROM #community/Architecture_Rules_&_CLAUDE.md
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_DB Pool & Query Layer (TS)]]
- 1 edge to [[_COMMUNITY_Environment & API Config]]
