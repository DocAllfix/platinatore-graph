...
- [[test_youtube_collector.py_1]] - code - il-platinatore-ai\harvester\tests\test_youtube_collector.py
- [[yt()]] - code - harvester\tests\test_youtube_collector.py

## Live Query (requires Dataview plugin)

```dataview
TABLE source_file, type FROM #community/Test:_YouTube_Collector
SORT file.name ASC
```
