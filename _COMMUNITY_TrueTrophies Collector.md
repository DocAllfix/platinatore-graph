...
```dataview
TABLE source_file, type FROM #community/TrueTrophies_Collector
SORT file.name ASC
```
...
## Top bridge nodes
- [[TrueTrophiesCollector]] - degree 6, connects to 2 communities
- [[TrueTrophiesCollector — collector per truetrophies.com.  TrueTrophies è una comm]] - degree 2, connects to 1 community
- [[Slug per TrueTrophies NFKD + lowercase + trattini come separatori.      Esempi]] - degree 2, connects to 1 community
- [[Collector per guide trofei su truetrophies.com.]] - degree 2, connects to 1 community
- [[Costruisce l'URL della pagina trofei per un gioco._1]] - degree 2, connects to 1 community