...
```dataview
TABLE source_file, type FROM #community/Collectors_·_steam_guide
SORT file.name ASC
```

## Connections to other communities
- 4 edges to [[_COMMUNITY_Collectors · per collector]]
- 2 edges to [[_COMMUNITY_Orchestrator · per guide]]
