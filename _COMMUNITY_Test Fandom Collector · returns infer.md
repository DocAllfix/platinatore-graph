...
# Test Fandom Collector · returns infer
...
```dataview
TABLE source_file, type FROM #community/Test_Fandom_Collector_·_returns_infer
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_Orchestrator · per guide]]

## Top bridge nodes
- [[Test FandomCollector — tutto mockato, zero rete reale.  Copre HTML stripping, g]] - degree 2, connects to 1 community