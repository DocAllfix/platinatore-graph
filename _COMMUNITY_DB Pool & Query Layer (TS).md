...
```dataview
TABLE source_file, type FROM #community/DB_Pool_&_Query_Layer_(TS)
SORT file.name ASC
```

## Connections to other communities
- 2 edges to [[_COMMUNITY_Architecture Rules & CLAUDE]]
- 2 edges to [[_COMMUNITY_Environment & API Config]]
