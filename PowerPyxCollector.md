...
- [[Collector per guide trofei su powerpyx.com.]] - `rationale_for` [EXTRACTED]
...
- [[HTML con contenuto  200 char → None.]] - `uses` [INFERRED]
- [[HTML valido → dict con tutti i campi richiesti.]] - `uses` [INFERRED]
...
- [[I tag script, style, nav non devono comparire nel raw_content.]] - `uses` [INFERRED]
...
- [[Stesso input HTML+URL → stesso content_hash.]] - `uses` [INFERRED]
- [[Test per PowerPyxCollector — extract, URL slug parsing, pulizia HTML.]] - `uses` [INFERRED]
- [[TestExtract]] - `uses` [INFERRED]
